...
public class SwimmerApp {
    ...
    public static void main(String[] args) {
        ...
        TrainingPlan b = new TrainingPlan('B',10,10);

        Swimmer a1 = a.createSwimmer("Jason",1997,lapTimes,"Viby");
        Swimmer a2 = a.createSwimmer("Jens", 1998,lapTimes,"Viby");

        for(Swimmer s : a.getSwimmers()){
            System.out.println(s.getName() + " " + s.bestLapTime());
        }
       a.removeSwimmer(a1);
        for(Swimmer s : a.getSwimmers()){
            System.out.println(s.getName() + " " + s.bestLapTime());
