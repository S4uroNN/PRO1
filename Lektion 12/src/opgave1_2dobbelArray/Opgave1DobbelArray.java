...
public class Opgave1DobbelArray {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("Value at: " + da.getValueAt(values,3,2));
        da.setValueAt(values,3,2,5);
        System.out.println("Value at: " + da.getValueAt(values,3,2));
        System.out.println();
        //System.out.println("Sum of row: " + da.sumRow(values, 3));
        //System.out.println("Sum of col: " + da.sumCol(values, 3));
